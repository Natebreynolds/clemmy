...
Useful historical context: `docs/checkpoints/2026-09-07-first-turn-and-discovery-handoff.md` explains the Facebook workflow-reuse and checkpoint failures; `docs/checkpoints/2026-09-07-outreach-task-handoff.md` describes cold-memory/discovery and outreach requirements. Treat their line numbers and observations as historical, and check current source before applying any recommendation.
