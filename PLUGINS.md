...
Then prompt: *"Turn my-pack into a Clementine plugin for <your domain>: rewrite plugin.json (id <you>.<pack>), the skills, workflows, and memory files following the formats in PLUGINS.md. Keep memory files structured-frontmatter with the whole fact in the description."*
