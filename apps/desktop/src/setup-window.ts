...
(function () {
  ...
  function renderAuth() {
    ...
    return [
      ...
      '  <div class="step-desc">I need one of these to talk to a language model. Pick the path that fits.</div>',
      '  <div class="choice">',
           card('openai', 'OpenAI API key', 'Best experience. Streaming, embeddings, structured outputs.'),
           card('codex',  'Codex OAuth (ChatGPT subscribers)', 'Free with a ChatGPT Plus subscription. Slightly less feature-rich.'),
