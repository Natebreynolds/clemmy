...
function AttentionStrip({ needsYou, workingNow }: { needsYou: CommandCenterItem[]; workingNow: CommandCenterItem[] }) {
    ...
    return (
      <div className="mx-auto flex h-full w-full max-w-3xl flex-col justify-center px-8 py-8">
        ...
        {(needsYou.length > 0 || workingNow.length > 0) && (
          <div className="mb-5">
            <AttentionStrip needsYou={needsYou} workingNow={workingNow} />
          </div>
        )}
