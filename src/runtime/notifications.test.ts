...
test('markNotificationGroupRead clears the anchor plus title/workflow twins, leaves others', async () => {
  const { markNotificationGroupRead } = await import('./notifications.js');
