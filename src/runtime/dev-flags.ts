...
export const DEV_FLAG_REGISTRY: DevFlagDef[] = [
  ...
  { key: 'CLEMMY_CODE_MODE_MANDATE', label: 'Code Mode adoption mandate', category: 'Tools & efficiency', type: 'boolean', default: 'on', description: 'On data-heavy turns (MCP data servers in scope), steer multi-fetch work to run_tool_program via a per-turn directive.' },
