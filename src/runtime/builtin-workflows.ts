  ...
  return {
    ...
    steps: [
      ...
      },
      {
        ...
        maxTurns: 8,
        retryBudget: 1,
        allowedTools: ['goal_create', 'goal_update', 'goal_list', 'task_add', 'write_file', 'workflow_step_result'],
        output: {
          type: 'object',
        ...
        prompt: [
          ...
          '- Prefer goal_create or goal_update for the long-running objective.',
      ...
      },
      {
        ...
        maxTurns: 10,
        retryBudget: 1,
        allowedTools: ['composio_search_tools', 'composio_list_tools', 'composio_execute_tool', 'write_file', 'goal_update', 'task_update', 'notify_user', 'workflow_step_result'],
        prompt: [
      ...
      },
      {
        ...
        sideEffect: 'write',
        maxTurns: 6,
        allowedTools: ['goal_update', 'task_update', 'notify_user', 'workflow_step_result'],
        output: {
          type: 'object',
