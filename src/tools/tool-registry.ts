...
export const TOOL_REGISTRY: ToolDecl[] = [
  ...
  { name: 'workflow_reshape', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'workflow-step', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Change the shape of an IN-FLIGHT workflow run: split a bottleneck into parallel branches, withhold a dark route, restore a recovered one. Completed work is immutable and approval gates cannot be bypassed.' },
