...
export const TOOL_REGISTRY: ToolDecl[] = [
  ...
  { name: 'complete_delegation', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'authoring', description: 'Finish a delegated task assigned to the current team agent by recording its result.' },
  ...
  { name: 'execution_reconcile_write', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'full-extra', loopClass: 'mutating', description: 'Settle an ambiguous/orphaned external write from read-back evidence: absent unlocks one retry, present records it done.' },
  { name: 'focus_activate', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Resume a previously parked focus.' },
  { name: 'focus_clear', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Mark a focus as done.' },
  ...
  { name: 'focus_park', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Park the active focus — flips it from active to paused so it stays resumable but no longe…' },
  { name: 'focus_set', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Pin a NEW current focus.' },
  { name: 'artifact_claim_resolve', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator'], loopClass: 'mutating', description: 'Resolve an unresolved provider-create claim after read-only verification: bind the found resource id (evidence-gated) or release a provably-absent claim.' },
  { name: 'focus_touch', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Bump the last-touched time + reset the idle-confirm window for an active focus.' },
  { name: 'focus_update', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], loopClass: 'mutating', description: 'Evolve an existing focus and optionally patch its sparse shared workstate.' },
  ...
  { name: 'pending_action_execute', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['worker'], needsApproval: false, loopClass: 'mutating', description: 'Execute the exact stored payload of an approved single-call pending action.' },
  ...
  { name: 'pending_action_queue', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['worker'], description: 'Queue a fully prepared action payload before an irreversible external write/send/deploy o…' },
  { name: 'pending_action_record_result', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['worker'], description: 'After executing or cancelling a queued action, record the outcome so Clementine can repor…' },
  ...
  { name: 'set_timer', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Schedule a one-time reminder notification ("remind me") at an exact time tonight or in N minutes, within 24 hours.' },
  ...
  { name: 'space_action_prepare', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain'], sdkLayer: 'authoring', featureGroup: 'spaces-dock', loopClass: 'mutating', description: 'Prepare one action already declared in a Workspace for exact user approval; never dispatches directly or accepts a tool override.' },
  ...
  { name: 'task_add', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Add a passive one-time item to the user\'s TODO list; it does not fire at a scheduled time.' },
  ...
  { name: 'workflow_reshape', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'workflow-step', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Add read-only prompt nodes with only a result channel and run-scoped artifact query, plus dependency edges into those nodes, on an active workflow run. Dynamic writes/sends, scripts, fan-out, and edge disable/enable are not supported; completed and in-flight targets are immutable.' },
  ...
  { name: 'workflow_update', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], description: 'Patch workflow fields. If `steps` is provided it replaces the entire graph; use workflow_edit_step for one targeted prompt edit.' },
