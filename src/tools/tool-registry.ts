...
export const TOOL_REGISTRY: ToolDecl[] = [
  { name: 'add_cron_job', sideEffect: 'write', tier: 'discoverable', lanes: ['cli'], blockedFor: ['workflow-step', 'worker'], description: 'Add a scheduled cron job to CRON.md.' },
  ...
  { name: 'agent_run_get', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'Fetch the full event timeline of a single autonomy cycle by runId.' },
  { name: 'agent_runs_recent', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'List recent autonomy cycles (daemon-source runs).' },
  { name: 'answer_check_in', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'Resolve an open check-in with an answer.' },
  { name: 'ask_user_question', sideEffect: 'read', tier: 'core', lanes: ['sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', blockedFor: ['workflow-step', 'worker'], description: 'Pause and ask the user a clarifying question.' },
  { name: 'background_task_status', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'Inspect a durable background task by task id, run id, or session id.' },
  ...
  { name: 'composio_execute_tool', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'agentic', codeMode: 'write', description: 'Execute any Composio action by exact slug (Outlook list-mail, Gmail search, Drive search,…' },
  { name: 'composio_list_tools', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'agentic', description: 'List available Composio tools for one connected toolkit slug, such as gmail, slack, notio…' },
  { name: 'composio_search_tools', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'agentic', codeMode: 'read', description: 'Search Composio for the right action slug.' },
  { name: 'composio_status', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Inspect whether Composio is configured and list active third-party app connections availa…' },
  ...
  { name: 'create_plan', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], description: 'Create a lightweight execution plan with concrete steps.' },
  ...
  { name: 'cron_list', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'List all scheduled cron jobs with schedules, next run times, and recent status.' },
  { name: 'cron_progress_read', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'Read saved progress state for a cron job.' },
  { name: 'cron_progress_write', sideEffect: 'write', tier: 'discoverable', lanes: ['cli'], description: 'Persist progress state for a cron job.' },
  { name: 'cron_run_history', sideEffect: 'write', tier: 'discoverable', lanes: ['cli'], description: 'Query recent execution history for a cron job.' },
  ...
  { name: 'discover_work', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'Scan handoffs, plans, goals, tasks, and inbox items to find prioritized work that should…' },
  ...
  { name: 'draft_goal_from_notes', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'cli'], description: 'Draft a durable goal from raw notes, meeting context, or a user-stated desired outcome.' },
  ...
  { name: 'execution_complete', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'full-extra', description: 'Mark an execution as completed.' },
  ...
  { name: 'execution_mark_blocked', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'full-extra', description: 'Mark an execution as blocked with a concrete blocker description.' },
  { name: 'execution_update_step', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'full-extra', description: 'Advance an execution: record the next concrete step and an optional summary of what just…' },
  { name: 'focus_activate', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Resume a previously parked focus.' },
  { name: 'focus_clear', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Mark a focus as done.' },
  { name: 'focus_get', sideEffect: 'read', tier: 'core', lanes: ['orchestrator'], description: 'Read the assistant\'s current attention pointer.' },
  { name: 'focus_park', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Park the active focus — flips it from active to paused so it stays resumable but no longe…' },
  { name: 'focus_set', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Pin a NEW current focus.' },
  { name: 'focus_touch', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Bump the last-touched time + reset the idle-confirm window for an active focus.' },
  { name: 'focus_update', sideEffect: 'write', tier: 'core', lanes: ['orchestrator'], description: 'Evolve an existing focus IN PLACE — same id, same active status, but updated title and/or…' },
  { name: 'git_status', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'Run a read-only git status in an allowed workspace directory.' },
  { name: 'goal_create', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Create a persistent goal that survives across sessions and can drive proactive work.' },
  { name: 'goal_get', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'Get a single goal with description, progress notes, next actions, blockers, and linked cr…' },
  { name: 'goal_list', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'List persistent goals, optionally filtered by owner or status.' },
  ...
  { name: 'goal_update', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Update an existing goal: status, progress, next actions, blockers, or linked cron jobs.' },
  ...
  { name: 'list_capabilities', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'List all known capabilities (the CLIs the agent knows how to detect).' },
  { name: 'list_files', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'List files in an allowed workspace directory.' },
  ...
  { name: 'list_plans', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'List the most recent plans and their progress.' },
  ...
  { name: 'memory_forget', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'Soft-delete a fact by id (sets active=0).' },
  ...
  { name: 'memory_list_facts', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'List durable facts.' },
  ...
  { name: 'memory_read', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Read a key memory file or a vault-relative markdown path.' },
  { name: 'memory_recall', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Recall vault chunks.' },
  { name: 'memory_remember', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'Record a durable fact in long-term memory.' },
  ...
  { name: 'memory_search', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Search the local Clementine vault for relevant notes and memories.' },
  ...
  { name: 'note_create', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Create a new note in the vault.' },
  { name: 'note_take', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Append a quick capture to today’s daily note.' },
  { name: 'notify_user', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'agentic', blockedFor: ['worker'], description: 'Send a notification to the user via the notification queue.' },
  ...
  { name: 'read_file', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Read a file from an allowed workspace path.' },
  { name: 'recall_tool_result', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode'], sdkLayer: 'read-only', codeMode: 'read', description: 'Retrieve the full verbatim output of a prior tool call by its call_id.' },
  { name: 'request_approval', sideEffect: 'write', tier: 'core', lanes: [], description: 'Pause and ask the user to approve a high-risk action or one batch of same-shape external…' },
  ...
  { name: 'run_shell_command', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'agentic', codeMode: 'write', description: 'Run a shell command in an allowed workspace directory.' },
  ...
  { name: 'schedule_list', sideEffect: 'read', tier: 'discoverable', lanes: ['cli'], description: 'List every active schedule in one place — scheduled workflows AND legacy cron jobs.' },
  { name: 'session_history', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Read recent conversation history for a session.' },
  ...
  { name: 'skill_list', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'List installed SKILL.md skills (Anthropic Skills format) with name + one-line description.' },
  { name: 'skill_read', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Load the full body of an installed SKILL.md skill into context.' },
  ...
  { name: 'task_add', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Add a SINGLE one-shot task to the user\'s TODO list.' },
  ...
  { name: 'task_list', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'List tasks from the master task list.' },
  { name: 'task_update', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Update a task by ID and optionally move it between pending and completed.' },
  ...
  { name: 'tool_choice_invalidate', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'Mark the currently-recorded tool choice for an intent as broken.' },
  { name: 'tool_choice_recall', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', description: 'Look up the previously-recorded tool choice for an intent (per-machine memory).' },
  { name: 'tool_choice_remember', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'cli'], description: 'Save the tool that worked for an intent so future runs skip discovery.' },
  ...
  { name: 'trigger_cron_job', sideEffect: 'write', tier: 'discoverable', lanes: ['cli'], blockedFor: ['workflow-step', 'worker'], description: 'Trigger an existing cron job to run immediately by writing a trigger file.' },
  ...
  { name: 'update_plan_step', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Update the status of a step in a saved plan.' },
  { name: 'user_profile_read', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', description: 'Read the user\'s current profile (name, role, timezone, working hours, communication prefe…' },
  { name: 'user_profile_update', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'cli'], description: 'Update the user profile.' },
  ...
  { name: 'workflow_get', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Fetch the full definition of a single workflow by name.' },
  ...
  { name: 'workflow_list', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'List all workflows with description, steps, and trigger metadata.' },
  { name: 'workflow_rerun_failed_items', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Re-run only the failed forEach items from a prior workflow run.' },
  { name: 'workflow_run', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['workflow-step', 'worker'], description: 'Dispatch a workflow to run in the BACKGROUND (fire-and-forget) — it runs in the daemon an…' },
  { name: 'workflow_run_status', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', description: 'Check workflow runs.' },
  ...
  { name: 'workspace_config', sideEffect: 'admin', tier: 'discoverable', lanes: ['orchestrator', 'cli'], description: 'View or modify workspace directories used for project discovery.' },
