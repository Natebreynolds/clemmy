...
export const TOOL_REGISTRY: ToolDecl[] = [
  ...
  { name: 'approval_decide', sideEffect: 'write', runtimeEffect: 'host_only', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', blockedFor: ['worker', 'workflow-step'], needsApproval: false, actionTopologyRole: 'control', description: 'Record the user\'s decision on the approval card this session is waiting on, after they answered in their own words.' },
