...
export const TOOL_REGISTRY: ToolDecl[] = [
  ...
  { name: 'goal_create', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Create a persistent goal that survives across sessions and can drive proactive work.' },
  { name: 'goal_get', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'cli'], loopClass: 'idempotent', description: 'Get a single goal with description, progress notes, next actions, blockers, and linked cr…' },
  ...
  { name: 'goal_update', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Update an existing goal: status, progress, next actions, blockers, or linked cron jobs.' },
  ...
  { name: 'list_plans', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'cli'], loopClass: 'idempotent', description: 'List the most recent plans and their progress.' },
  ...
  { name: 'memory_list_facts', sideEffect: 'read', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', loopClass: 'idempotent', description: 'List durable facts.' },
  ...
  { name: 'memory_read', sideEffect: 'read', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'code-mode', 'cli'], sdkLayer: 'read-only', codeMode: 'read', loopClass: 'idempotent', description: 'Read a key memory file or a vault-relative markdown path.' },
  ...
  { name: 'memory_mark_used', sideEffect: 'write', tier: 'core', lanes: ['orchestrator', 'sdk-brain', 'sdk-worker', 'cli'], sdkLayer: 'read-only', loopClass: 'mutating', description: 'Credit only exact memory refs that materially changed the current answer, plan, scope, or tool choice.' },
  ...
  { name: 'note_take', sideEffect: 'write', tier: 'discoverable', lanes: ['orchestrator', 'sdk-brain', 'cli'], sdkLayer: 'authoring', loopClass: 'mutating', description: 'Append a quick capture to today’s daily note.' },
